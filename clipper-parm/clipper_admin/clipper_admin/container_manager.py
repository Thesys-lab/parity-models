...
def create_model_container_label(name, version, redundant):
    return "{name}{delim}{version}{delim}{red}".format(
        name=name, delim=_MODEL_CONTAINER_LABEL_DELIMITER, version=version, red=int(redundant))
