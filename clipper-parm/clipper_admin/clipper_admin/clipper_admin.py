...
class ClipperConnection(object):
    def __init__(self, container_manager, distributed):
    ...
    def register_application(self, name, input_type, default_output,
                             slo_micros, prefer_original=False):
        ...
        prefer_original : bool
            When the application issues redundant predictions, this flag
            determines whether there should be any preference for the original
            requests over redundant ones.
        ...
        req_json = json.dumps({
            ...
            "prefer_original": int(prefer_original)
        })
    ...
    def build_and_deploy_model(self,
        ...
        redundant : bool, optional
            Whether the models being launched are redundant.
        ...
        self.deploy_model(name, version, input_type, image, labels,
                          num_replicas, batch_size, redundant, volumes, cmd)
