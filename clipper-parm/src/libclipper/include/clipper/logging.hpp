...
const std::string LOGGING_TAG_PARM = "PARM";
const std::string LOGGING_TAG_EC_METRICS = "EC_METRICS";
...
#ifndef NDEBUG
static void log_flush() { Logger::get().flush(); }
#else
static void log_flush() { return; }
#endif
